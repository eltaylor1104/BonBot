...
class utility(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.set_description("I am an epic bot created by **judger#6969**. All of my commands are seen and run via slash commands, you may view those by typing `/` in a chat that you have the `Use Slash Commands` permission. You may also see this message by using the command `b!about`.")
