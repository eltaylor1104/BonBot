...
class Slash(commands.Cog):
    ...
    options=[Option("message id", "A message ID for me to reply to", Type.INTEGER, required=True), Option("message", "The content of the reply", Type.STRING, required=True)])
